...
?>
	...
	<div id="api-wrapper">
		<div id="nav-wrap">
			<div id="nav">
				<a href="highmaps.php" style="position:absolute;">返回首页</a>
				...
				<div class="nav-section">
					...
					<p class="subheader">HighMap 所有配置属性。</p>
					...
					<div id="options-tree">
						...
						<code>$("#container").highcharts({"Map"</code>
				...
				<div class="nav-section">
					...
					<p class="subheader">HighMaps 所有函数列表及说明。</p>
		...
		<div id="details-wrap">
			<div id="details">
				...
				<div class="primary" style="display:none">
					...
					-->
					<h1>版本信息</h1>
					<p>hm api v0.1 for HighMaps beta ；最后更新时间：2014-05-23</p>
